...
```{css}
<object data="RegistrationForm.pdf" type="pdf/pdf" width="100%" height="100%" style="min-height:100vh;">
    <p>It appears you don't have a PDF plugin for this browser.
    No biggie... you can <a href="RegistrationForm.pdf">click here to
...
```{=html}
<!-- <p class="text-center"> -->
<!--   <a class="btn btn-primary btn-lg form-download" href="pdf/RegistrationForm.pdf" target="_blank"> -->
<!--     <i class="fa-solid fa-file-arrow-down"></i>&ensp;Download Registration Form -->
<!--   </a> -->
<!-- </p> -->

<!-- <div class="embed-container"> -->
<!--   <iframe src="pdf/RegistrationForm.pdf" style="border: 0.5px"></iframe> -->
<!-- </div> -->
```
